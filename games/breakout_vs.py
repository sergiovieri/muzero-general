...
from .game_vs import make_vs
from .breakout import Game as GameOri
...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Game
        self.observation_shape = (9, 96, 96)  # Dimensions of the game observation, must be 3D (channel, height, width). For a 1D array, please reshape it to (1, 1, length of array)
        ...
        self.td_steps = 1000  # Number of steps in the future to take into account for calculating the target value
