...
game_name = 'Alien-v4'
action_space = list(range(gym.make(game_name).unwrapped._n_actions))
...
class MuZeroConfig:
    def __init__(self):
        ...
        self.action_space = list(range(6))#action_space  # Fixed list of all possible actions. You should only edit the length
