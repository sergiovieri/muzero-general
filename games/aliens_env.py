...
class MuZeroConfig:
    def __init__(self):
        ...
        self.ratio_min = 0.01  # Desired training steps per self played step ratio. Equivalent to a synchronous version, training can take much longer. Set it to None to disable it
        self.ratio_max = 0.25
