...
class MuZeroConfig:
    def __init__(self):
        ...
        #Jago
        self.jago_blocks = 4
        self.jago_encoding_size = 512
        self.jago_fc_reward_layers = 128
        self.jago_fc_value_layers = 128
        self.jago_fc_policy_layers = 128
        ...
        self.ratio_min = 0.5  # Desired training steps per self played step ratio. Equivalent to a synchronous version, training can take much longer. Set it to None to disable it
        self.ratio_max = 0.75
    ...
    def visit_softmax_temperature_fn(self, trained_steps):
        ...
        if trained_steps < 100:
            return 100.0
        if trained_steps < 10e3:
            return 1.0
        elif trained_steps < 50e3:
            return 0.5
        else:
            return 0.25
